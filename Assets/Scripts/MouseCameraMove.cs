...
public class MouseCameraMove : MonoBehaviour
{
	...
	void Update()
    {
        float mouse_X = Input.GetAxis("Mouse X") * mouse_speed * Time.deltaTime; // Current X position of mouse
        float mouse_Y = Input.GetAxis("Mouse Y") * mouse_speed * Time.deltaTime; // Current Y position of mouse
